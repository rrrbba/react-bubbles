...
- [ ] Explain what a token is used for.
  ...
  It authenticates a person's identity by storing some personal data.

- [ ] What steps can you take in your web apps to keep your data secure?

  You should use HTTPS because it secures the transfer of information, also you should make sure your passwords are secure.

- [ ] Describe how web servers work.

  It is a program that uses HTTPS to bring the files from web pages to users as a response to their requests. This is an example of client/server model.
